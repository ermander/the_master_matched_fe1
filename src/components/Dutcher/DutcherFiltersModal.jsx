...
export default class DutcherFiltersModal extends Component {
  ...
  setMarketFilters = (market) => {
    ...
    if (market === "all") {
      this.state.all === true
        ? this.setState({ all: true, dc: false, uo: false, ggNg: false })
        : this.setState({ all: true, dc: false, uo: false, ggNg: false });
    }
    if (market === "dc") {
      this.state.dc === true
        ? this.setState({ all: false, dc: false })
        : this.setState({ all: false, dc: true });
    }
    if (market === "uo") {
      this.state.uo === true
        ? this.setState({ all: false, uo: false })
        : this.setState({ all: false, uo: true });
    }
    if (market === "ggNg") {
      this.state.ggNg === true
        ? this.setState({ all: false, ggNg: false })
        : this.setState({ all: false, ggNg: true });
    }
  };
    ...
    return (
      <Modal show={this.props.show} onHide={this.props.onHide}>
            ...
            <div className="forms-cols">
              ...
              <div>
                <Form.Check
                  ...
                  onChange={() => this.setMarketFilters("all")}
                ></Form.Check>
                <Form.Check inline>
                  <span>Tutti</span>
                </Form.Check>
              ...
              <div>
                <Form.Check
                  ...
                  onChange={() => this.setMarketFilters("dc")}
                ></Form.Check>
                <Form.Check inline>
                  <span>DC</span>
                </Form.Check>
              ...
              <div>
                <Form.Check
                  inline
                  checked={this.state.uo}
                  onChange={() => this.setMarketFilters("uo")}
                ></Form.Check>
                <Form.Check inline>
                  <span>U/O</span>
                </Form.Check>
              ...
              <div>
                <Form.Check
                  inline
                  checked={this.state.ggNg}
                  onChange={() => this.setMarketFilters("ggNg")}
                ></Form.Check>
                <Form.Check inline>
                  <span>GG/NG</span>
                </Form.Check>
          ...
          <Col xs={2}>
            <div className="forms-cols">
              ...
              <Row>
                <Col xs={12}>
                  <InputGroup>
                    <FormControl type="text" placeholder="Stake Punta €" />
                  </InputGroup>
                </Col>
              </Row>
              <Row>
                <Col xs={12}>
                  <InputGroup>
                    <FormControl type="text" placeholder="Rimborso %" />
                  </InputGroup>
                </Col>
              </Row>
              <Row>
        ...
        <Row className="filters-footer">
          ...
          <Col xs={12} md={4}>
            <Button onClick={this.props.reSetOdds} variant="danger">
              Reset
            </Button>
          </Col>
        </Row>
